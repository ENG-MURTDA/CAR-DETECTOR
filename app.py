...
if file is not None:
    img = Image.open(file)
    # تعديل سطر 13: استخدمنا column_width للتوافق مع نسخة 1.31
    st.image(img, caption="الصورة المرفوعة", use_column_width=True)
    
    # تحضير الصورة للموديل
    img_resized = img.resize((224, 224))
    img_array = np.array(img_resized) / 255.0
    # تعديل سطر 18: تصحيح اسم الدالة إلى expand_dims
    ...
    try:
        ...
        st.success("🎉 مبروك! الموديل اشتغل ورفعنا الصورة بنجاح.")
